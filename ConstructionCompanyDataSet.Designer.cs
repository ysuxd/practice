...
namespace WindowsFormsApp1 {
    ...
    public partial class ConstructionCompanyDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientRow AddClientRow(int id_client, string FirstName, string LastName, string MidName, decimal PhoneNumber, string Addres, string Email) {
        ...
        public partial class ClientRow : global::System.Data.DataRow {
            ...
            public decimal PhoneNumber {
                get {
                    return ((decimal)(this[this.tableClient.PhoneNumberColumn]));
                }
                set {
            ...
            public string Addres {
                get {
                    return ((string)(this[this.tableClient.AddresColumn]));
                }
                set {
                    this[this.tableClient.AddresColumn] = value;
                }
            }
...
namespace WindowsFormsApp1.ConstructionCompanyDataSetTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Client] WHERE (([id_client] = @Original_id_client) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([MidName] = @Original_MidName) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Addres] = @Original_Addres) AND ([Email] = @Original_Email))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Client] ([id_client], [FirstName], [LastName], [MidName], [PhoneNumber], [Addres], [Email]) VALUES (@id_client, @FirstName, @LastName, @MidName, @PhoneNumber, @Addres, @Email);
SELECT id_client, FirstName, LastName, MidName, PhoneNumber, Addres, Email FROM Client WHERE (id_client = @id_client)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Client] SET [id_client] = @id_client, [FirstName] = @FirstName, [LastName] = @LastName, [MidName] = @MidName, [PhoneNumber] = @PhoneNumber, [Addres] = @Addres, [Email] = @Email WHERE (([id_client] = @Original_id_client) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([MidName] = @Original_MidName) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Addres] = @Original_Addres) AND ([Email] = @Original_Email));
SELECT id_client, FirstName, LastName, MidName, PhoneNumber, Addres, Email FROM Client WHERE (id_client = @id_client)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_client, FirstName, LastName, MidName, PhoneNumber, Addres, Email FROM d" +
                "bo.Client";
        ...
        public virtual int Fill(ConstructionCompanyDataSet.ClientDataTable dataTable) {
        ...
        public virtual ConstructionCompanyDataSet.ClientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ConstructionCompanyDataSet.ClientDataTable dataTable = new ConstructionCompanyDataSet.ClientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ConstructionCompanyDataSet.ClientDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_client, string Original_FirstName, string Original_LastName, string Original_MidName, decimal Original_PhoneNumber, string Original_Addres, string Original_Email) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_PhoneNumber));
        ...
        public virtual int Insert(int id_client, string FirstName, string LastName, string MidName, decimal PhoneNumber, string Addres, string Email) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((decimal)(PhoneNumber));
            if ((Addres == null)) {
        ...
        public virtual int Update(int id_client, string FirstName, string LastName, string MidName, decimal PhoneNumber, string Addres, string Email, int Original_id_client, string Original_FirstName, string Original_LastName, string Original_MidName, decimal Original_PhoneNumber, string Original_Addres, string Original_Email) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(PhoneNumber));
            if ((Addres == null)) {
                throw new global::System.ArgumentNullException("Addres");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((decimal)(Original_PhoneNumber));
            if ((Original_Addres == null)) {
                throw new global::System.ArgumentNullException("Original_Addres");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string MidName, decimal PhoneNumber, string Addres, string Email, int Original_id_client, string Original_FirstName, string Original_LastName, string Original_MidName, decimal Original_PhoneNumber, string Original_Addres, string Original_Email) {
            return this.Update(Original_id_client, FirstName, LastName, MidName, PhoneNumber, Addres, Email, Original_id_client, Original_FirstName, Original_LastName, Original_MidName, Original_PhoneNumber, Original_Addres, Original_Email);
        }
    }
